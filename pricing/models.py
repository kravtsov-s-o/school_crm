...
class AbstractPrice(TimeStampMixin):
    ...
    currency = models.ForeignKey("school_settings.Currency", on_delete=models.PROTECT, verbose_name=_('Currency'))
    language = models.ForeignKey("school_settings.Language", on_delete=models.PROTECT, verbose_name=_('Language'))
    lesson_type = models.ForeignKey("school_settings.LessonType", on_delete=models.PROTECT, verbose_name=_('Lesson Type'))
...
class AbstractPriceRow(TimeStampMixin):
    duration = models.ForeignKey("school_settings.Duration", on_delete=models.PROTECT, verbose_name=_('Duration'))
...
class SchoolPriceRow(AbstractPriceRow):
    plan = models.ForeignKey(SchoolPrice, on_delete=models.CASCADE, related_name='rows', verbose_name=_('School Price'))
...
class TeacherRateRow(AbstractPriceRow):
    plan = models.ForeignKey(TeacherRate, on_delete=models.CASCADE, related_name='rows', verbose_name=_('Teacher Rate'))
